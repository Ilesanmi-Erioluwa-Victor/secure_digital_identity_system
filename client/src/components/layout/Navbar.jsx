        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-neutral-200 py-1">
            <div className="px-4 py-2 border-b border-neutral-100">
              ...
              <p className="text-xs text-neutral-400">user@institution.edu</p>
            </div>
            <button className="w-full px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-50 text-left flex items-center gap-2">
            ...
            <button className="w-full px-4 py-2 text-sm text-status-revoked hover:bg-red-50 text-left flex items-center gap-2">
              Logout
            </button>
          </div>
        )}
